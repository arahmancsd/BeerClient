...
export const environment = {
  production: false,
  urlSingleBeer: 'https://thingproxy.freeboard.io/fetch/https://sandbox-api.brewerydb.com/v2/beer/',
  ...
  */
  ...
  corsEnabledUrl: 'https://thingproxy.freeboard.io/fetch/https://sandbox-api.brewerydb.com/v2/beers/',
